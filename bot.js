...
client.on('ready', () => {
  ...
  client.user.setGame(`فويد بوت | In ${client.guilds.size} Server `,"http://twitch.tv/xmas")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
if(message.content.startsWith(prefix + "daily")) {
  ...
  if(profile[message.author.id].lastDaily != moment().format('day')) {
   ...
   profile[message.author.id].credits += 999999999999999999999999
...
if (!profile[sender.id].credits) profile[sender.id].credits = 999999999999999999999999;
fs.writeFile('./profile.json', JSON.stringify(profile), (err) => {
if (err) console.error(err);
})
